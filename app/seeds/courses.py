...
def seed_courses():
    for course in [
        ...
        },
        {
            ...
            "categories_for_course": [development, it, productivity],
        },
        {
        ...
        },
        {
            ...
            "categories_for_course": [development, personal_development],
        },
        {
        ...
        },
        {
            ...
            "categories_for_course": [health, business]
        },
        {
            "name": "Touch type like a pro!",
        ...
        },
        {
            ...
            "categories_for_course": [personal_development, design, health],
        },
        {
            ...
            "course_video": "https://s3.us-east-2.amazonaws.com/lfm.video/st-pexels-creativ-medium-5657579+(2160p).mp4",
            "categories_for_course": [finance, marketing, music],
        },
        {
